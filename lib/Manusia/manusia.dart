...
class ManusiaQuiz extends StatefulWidget {
  const ManusiaQuiz({Key? key});

  @override
  _ManusiaQuizState createState() => _ManusiaQuizState();
}

class _ManusiaQuizState extends State<ManusiaQuiz> {
  List<dynamic> _questions = [];
  List<String> _selectedValues = [];

  Future<void> _fetchQuestions() async {
    final response = await http
        .get(Uri.parse('http://192.168.68.105:3001/api/data/manusia'));
              ...
              child: Column(
                ...
                children: [
                  ...
                  ...choices.map((choice) => RadioListTile(
                        title: Text(choice,
                            style:
                                const TextStyle(fontFamily: 'Bubblegum Sans')),
                        value: choice,
