...
class BahanQuiz extends StatefulWidget {
  const BahanQuiz({super.key});

  @override
  _BahanQuizState createState() => _BahanQuizState();
}

class _BahanQuizState extends State<BahanQuiz> {
  List<dynamic> _questions = [];
  List<String> _selectedValues = [];

  Future<void> _fetchQuestions() async {
    final response =
        await http.get(Uri.parse('http://192.168.68.105:3001/api/data/bahan'));
